        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-16 px-4 text-left lg:px-0 lg:text-center">
            ...
            <p className="max-w-none text-lg text-pretty text-foreground lg:mx-auto lg:max-w-2xl">
              Scrivici e il team di Steps Dance School ti aiutera a scegliere il percorso piu adatto a te. Ti rispondiamo con orari, disponibilita e i prossimi passi per iniziare.
            </p>
          </div>
