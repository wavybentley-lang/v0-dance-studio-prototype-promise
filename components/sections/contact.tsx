...
const courseOptions = [
  ...
  "Tecnica accademica",
  "Danza moderna",
  "Gestualità corporea e coreografica",
  "Educazione musicale",
  "Recitazione",
  "Saggi",
  "Spettacoli",
      ...
      <div className="relative z-10 bg-[#050505] py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="aspect-video w-full overflow-hidden rounded-sm border border-border md:aspect-[21/9]">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3017.772667196031!2d14.272772799999998!3d40.854914699999995!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x133b097ff8e851ff%3A0x1a8a9cd214b38671!2sAccademia%20di%20Danza%20%22Promise%22!5e0!3m2!1sen!2sit!4v1780658682879!5m2!1sen!2sit"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen
